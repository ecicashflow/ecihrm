...
export const APPRAISAL_STATUS_LABELS: Record<string, string> = {
  assigned_to_employee: 'Active / Employee Pending',
  submitted_by_employee: 'Employee Submitted / Supervisor Pending',
  submitted_by_supervisor: 'Supervisor Submitted / HR Review Pending',
  submitted_to_management: 'HR Submitted / Management Review Pending',
  management_returned_to_hr: 'Management Submitted / HR Final Review Pending',
  submitted_to_ceo: 'HR Final Submitted / CEO Approval Pending',
  approved: 'Approved / Final',
  returned_for_correction: 'Returned for Correction',
  returned_for_employee_revision: 'Returned for Employee Revision',
  returned_for_supervisor_revision: 'Returned for Supervisor Revision',
  returned_for_hr_revision: 'Returned for HR Revision',
  returned_for_management_revision: 'Returned for Management Revision',
...
export const APPRAISAL_STATUS_COLORS: Record<string, string> = {
  ...
  management_returned_to_hr: 'bg-violet-100 text-violet-800',
  submitted_to_ceo: 'bg-purple-100 text-purple-800',
  approved: 'bg-green-100 text-green-800',
  returned_for_correction: 'bg-red-100 text-red-800',
  returned_for_employee_revision: 'bg-red-100 text-red-800',
  returned_for_supervisor_revision: 'bg-orange-100 text-orange-800',
  returned_for_hr_revision: 'bg-amber-100 text-amber-800',
  returned_for_management_revision: 'bg-orange-100 text-orange-800',
  reopened_by_admin: 'bg-pink-100 text-pink-800',
